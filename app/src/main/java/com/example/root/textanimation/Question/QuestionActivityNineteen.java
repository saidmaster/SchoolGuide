...
public class QuestionActivityNineteen extends AppCompatActivity {
    // prevent back press
    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) {

        AlertDialog.Builder builder = new AlertDialog.Builder(QuestionActivityNineteen.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // previous Activity
                Intent i = new Intent(QuestionActivityNineteen.this, QuestionActivityeighteen.class);
                startActivity(i);
        ...
        final TextView questionS1 = (TextView) findViewById(R.id.questionS1);
        final TextView questionS2 = (TextView) findViewById(R.id.questionS2);
        final TextView questionS3 = (TextView) findViewById(R.id.questionS3);
        ...
        questionS1.startAnimation(anim);
        questionS2.startAnimation(anim);
        questionS3.startAnimation(anim);
        ...
        r1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                questionS1.setBackgroundColor(getResources().getColor(R.color.greenColor));
                questionS2.setBackgroundColor(getResources().getColor(R.color.white));
                questionS3.setBackgroundColor(getResources().getColor(R.color.white));
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // color of the back ground if the user check his choise
                questionS2.setBackgroundColor(getResources().getColor(R.color.greenColor));
                questionS1.setBackgroundColor(getResources().getColor(R.color.white));
                questionS3.setBackgroundColor(getResources().getColor(R.color.white));
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // color of the back ground if the user check his choise
                questionS3.setBackgroundColor(getResources().getColor(R.color.greenColor));
                questionS1.setBackgroundColor(getResources().getColor(R.color.white));
                questionS2.setBackgroundColor(getResources().getColor(R.color.white));
        ...
        questionS2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        questionS3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button btbB = (Button) findViewById(R.id.btnQuestionNineTeen);
        btbB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(QuestionActivityNineteen.this, QuestionActivityTwenty.class);

                if(r1.isChecked()){
                    startActivity(i);
                    overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                    CollectDataFromRadioButton.setRadioValue(ValueStrings.QUESTION_S_1);
                    ...
                    startActivity(i);
                    overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                    CollectDataFromRadioButton.setRadioValue(ValueStrings.QUESTION_S_2);
                    ...
                    startActivity(i);
                    overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                    CollectDataFromRadioButton.setRadioValue(ValueStrings.QUESTION_S_3);
